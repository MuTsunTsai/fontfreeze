...
> Freeze variations and features in a font.
...
- For the meaning of each feature, look up the user manual of your font.
  ...
  (Hover your mouse over a tag name to display a link to the corresponding documentation on the Microsoft Typography website.)
...
- To work with [Nerd Fonts](https://github.com/ryanoasis/nerd-fonts),
  ...
  Doing it the other way could lead to error (see [#8](https://github.com/MuTsunTsai/fontfreeze/issues/8#event-9248246359)).
...
- [OpenType Feature Freezer](https://github.com/twardoch/fonttools-opentype-feature-freezer),
  for inspiring the name (I used an additional approach to freeze the features, though).
